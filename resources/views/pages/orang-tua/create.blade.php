...
@section('content')
<div class="pagetitle">
    <h1>Tambah Data Orang Tua / Wali</h1>
    <nav>
        <ol class="breadcrumb">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title mb-0 p-0 fs-6 fw-bold">
                        <i class="bi bi-person-lines-fill me-2 text-primary"></i>Form Tambah Data Orang Tua / Wali Mahasiswa
                    </h5>
                </div>
                    ...
                    <form action="{{ route('orang-tua.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_ayah" id="nama_ayah" class="form-control @error('nama_ayah') is-invalid @enderror" value="{{ old('nama_ayah') }}" placeholder="Masukkan nama lengkap ayah">
                                    @error('nama_ayah')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="pekerjaan_ayah" id="pekerjaan_ayah" class="form-control @error('pekerjaan_ayah') is-invalid @enderror" value="{{ old('pekerjaan_ayah') }}" placeholder="Contoh: PNS / Wiraswasta / Petani / Karyawan Swasta">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="pendidikan_ayah" id="pendidikan_ayah" class="form-select @error('pendidikan_ayah') is-invalid @enderror">
                                        <option value="" disabled {{ old('pendidikan_ayah') ? '' : 'selected' }}>-- Pilih Pendidikan Ayah --</option>
                                        @foreach($pendidikanList as $pen)
                                            <option value="{{ $pen }}" {{ old('pendidikan_ayah') == $pen ? 'selected' : '' }}>
                                                {{ $pen }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_ibu" id="nama_ibu" class="form-control @error('nama_ibu') is-invalid @enderror" value="{{ old('nama_ibu') }}" placeholder="Masukkan nama lengkap ibu">
                                    @error('nama_ibu')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="pekerjaan_ibu" id="pekerjaan_ibu" class="form-control @error('pekerjaan_ibu') is-invalid @enderror" value="{{ old('pekerjaan_ibu') }}" placeholder="Contoh: Ibu Rumah Tangga / PNS / Guru / Wiraswasta">
                                    @error('pekerjaan_ibu')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="pendidikan_ibu" id="pendidikan_ibu" class="form-select @error('pendidikan_ibu') is-invalid @enderror">
                                        <option value="" disabled {{ old('pendidikan_ibu') ? '' : 'selected' }}>-- Pilih Pendidikan Ibu --</option>
                                        @foreach($pendidikanList as $pen)
                                            <option value="{{ $pen }}" {{ old('pendidikan_ibu') == $pen ? 'selected' : '' }}>
                                                {{ $pen }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="no_hp" id="no_hp" class="form-control @error('no_hp') is-invalid @enderror" value="{{ old('no_hp') }}" placeholder="Contoh: 08xxxxxxxxxx">
                                    @error('no_hp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="penghasilan_orang_tua" id="penghasilan_orang_tua" class="form-select @error('penghasilan_orang_tua') is-invalid @enderror">
                                        <option value="" disabled {{ old('penghasilan_orang_tua') ? '' : 'selected' }}>-- Pilih Rentang Penghasilan --</option>
                                        @foreach($penghasilanList as $penghasilan)
                                            <option value="{{ $penghasilan }}" {{ old('penghasilan_orang_tua') == $penghasilan ? 'selected' : '' }}>
                                                {{ $penghasilan }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="nama_wali" id="nama_wali" class="form-control @error('nama_wali') is-invalid @enderror" value="{{ old('nama_wali') }}" placeholder="Nama wali">
                                        @error('nama_wali')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="pekerjaan_wali" id="pekerjaan_wali" class="form-control @error('pekerjaan_wali') is-invalid @enderror" value="{{ old('pekerjaan_wali') }}" placeholder="Pekerjaan wali">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="alamat" id="alamat" rows="2" class="form-control @error('alamat') is-invalid @enderror" placeholder="Alamat domisili tempat tinggal orang tua/wali">{{ old('alamat') }}</textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-1"></i> Simpan Data Orang Tua/Wali
                            </button>
                        </div>
