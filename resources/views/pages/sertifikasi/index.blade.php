            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body pt-3">
                    <div class="table-responsive">
                        {!! $dataTable->table(['class' => 'table table-hover table-striped w-100 align-middle', 'id' => 'sertifikasi-table']) !!}
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        $(document).on('click', '.btn-delete', function(e) {
            ...
            const name = $(this).data('name') || 'sertifikasi ini';

            Swal.fire({
                title: 'Apakah Anda yakin?',
                text: `Sertifikasi "${name}" akan dihapus permanen!`,
                icon: 'warning',
