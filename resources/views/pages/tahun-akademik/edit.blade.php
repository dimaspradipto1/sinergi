            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title mb-0 p-0 fs-6 fw-bold">
                        <i class="bi bi-pencil-square me-2 text-warning"></i>Form Edit Data Tahun Akademik
                    </h5>
                </div>
                ...
                <div class="card-body pt-4">
                    <form action="{{ route('tahun-akademik.update', $tahunAkademik->id) }}" method="POST">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="tahun_akademik" id="tahun_akademik" class="form-control @error('tahun_akademik') is-invalid @enderror" value="{{ old('tahun_akademik', $tahunAkademik->tahun_akademik) }}" placeholder="Contoh: 2026/2027 Ganjil atau 2026/2027" required autofocus>
