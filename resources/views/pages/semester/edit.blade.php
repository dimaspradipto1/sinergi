            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="card-title mb-0 p-0 fs-6 fw-bold">
                        <i class="bi bi-pencil-square me-2 text-warning"></i>Form Edit Data Semester
                    </h5>
                </div>
                ...
                <div class="card-body pt-4">
                    <form action="{{ route('semester.update', $semester->id) }}" method="POST">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="semester" id="semester" class="form-control @error('semester') is-invalid @enderror" value="{{ old('semester', $semester->semester) }}" placeholder="Contoh: SEMESTER SATU (I)" required autofocus>
                                @error('semester')
