...
class HasilAsesmenDataTable extends DataTable
{
    /**
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                ...
                <div class="d-flex justify-content-center align-items-center gap-1">
                    <a href="' . $showUrl . '" class="btn btn-sm btn-primary" title="Lihat Rapor Hasil Asesmen">
                        <i class="bi bi-file-earmark-bar-graph me-1"></i> Rapor Hasil
                    </a>
                </div>';
            })
    ...
    {
        return $model->newQuery()->with(['mahasiswa', 'mahasiswa.programStudi', 'instrumenAsesmen'])->select('asesmen_mahasiswas.*');
    }
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
                    ...
                    ->parameters([
                        ...
                        'language' => [
                            'search' => '_INPUT_',
                            'searchPlaceholder' => 'Cari hasil asesmen...',
                            'lengthMenu' => '_MENU_ data per halaman',
                            'info' => 'Menampilkan _START_ sampai _END_ dari _TOTAL_ data',
                            'infoEmpty' => 'Menampilkan 0 sampai 0 dari 0 data',
                            'infoFiltered' => '(disaring dari _MAX_ total data)',
                            'zeroRecords' => 'Data hasil asesmen tidak ditemukan',
                            'paginate' => [
                                'first' => 'Awal',
                                'last' => 'Akhir',
                                'next' => 'Berikutnya',
    ...
    {
        return 'HasilAsesmen_' . date('YmdHis');
    }
}
